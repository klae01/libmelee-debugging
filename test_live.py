...
class DolphinTest(unittest.TestCase):
    ...
    def test_character_select(self):
        ...
        while True:
            ...
            if gamestate.menu_state == melee.enums.Menu.IN_GAME:
                ...
                if gamestate.menu_state == melee.enums.Menu.CHARACTER_SELECT and (
                    gamestate.frame > 30
                ):
                    self.assertEqual(
                        gamestate.player[1].character_selected, melee.Character.FOX
                    )
                    break
        console.stop()
    ...
    def test_two_controllers_in_game(self):
        ...
        controller_one = melee.Controller(
            console=console, port=1, type=melee.ControllerType.STANDARD
        )
        controller_two = melee.Controller(
        ...
        while True:
            ...
            if gamestate.menu_state == melee.enums.Menu.IN_GAME:
                if gamestate.frame == -123:
                    ...
                    self.assertEqual(
                        gamestate.player[2].character, melee.Character.MARTH
                    )
                    ...
                    self.assertEqual(
                        gamestate.player[1].action, melee.Action.DOWN_B_GROUND_START
                    )
