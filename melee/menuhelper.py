...
def choosecharacter(character, ai_state, controller):
    ...
    isOverCharacter = (
        abs(ai_state.cursor_x - target_x) < wiggleroom
        and abs(ai_state.cursor_y - target_y) < wiggleroom
    )
    isFarOutsideCharacter = (
        abs(ai_state.cursor_x - target_x) > wiggleroom * 3
        or abs(ai_state.cursor_y - target_y) > wiggleroom * 3
    )
