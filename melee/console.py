...
class Console:
    ...
    def __post_frame(self, gamestate, event_bytes):
        ...
        if controller_port in self._prev_gamestate.players:
            playerstate.invulnerability_left = max(
                0,
                self._prev_gamestate.players[controller_port].invulnerability_left - 1,
            )
    ...
    def __handle_slippstream_menu_event(self, event_bytes, gamestate):
        ...
        if gamestate.menu_state in [
            ...
            # Character selected
            try:
                gamestate.players[1].character_selected = enums.to_internal(
            ...
            try:
                gamestate.players[2].character_selected = enums.to_internal(
            ...
            try:
                gamestate.players[3].character_selected = enums.to_internal(
            ...
            try:
                gamestate.players[4].character_selected = enums.to_internal(
