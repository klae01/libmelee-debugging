                    ...
                    if len(message["payload"]) > 0:
                        if self.is_dolphin:
                            frame_ended = self.__handle_slippstream_events(
                                base64.b64decode(message["payload"]), gamestate
                            )
                        else:
                            frame_ended = self.__handle_slippstream_events(
    ...
    def __handle_slippstream_events(self, event_bytes, gamestate):
        ...
        while len(event_bytes) > 0:
            ...
            if EventType(event_bytes[0]) == EventType.PAYLOADS:
                ...
                # ECB Right edge
                try:
                    gamestate.player[controller_port].ecb_right = unpack(
                        ">f", event_bytes[0x49 : 0x49 + 4]
                    )[0]
                except error:
                ...
                # ECB Top edge
                try:
                    gamestate.player[controller_port].ecb_top = unpack(
                        ">f", event_bytes[0x4D : 0x4D + 4]
                    )[0]
                except error:
                ...
                # ECB Left edge
                try:
                    gamestate.player[controller_port].ecb_left = unpack(
                        ">f", event_bytes[0x51 : 0x51 + 4]
                    )[0]
                except error:
                ...
                # ECB Bottom edge
                try:
                    gamestate.player[controller_port].ecb_bottom = unpack(
                        ">f", event_bytes[0x55 : 0x55 + 4]
                    )[0]
                except error:
