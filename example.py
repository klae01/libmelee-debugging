    ...
    if gamestate.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
        ...
        if log:
            log.log(
                "Notes",
                " At end of hit: "
                + str(framedata.hit_distance(gamestate.player[2]))
                + " ",
                concat=True,
            )
            log.log(
                "Notes",
                " Current speed: "
                + str(gamestate.player[2].speed_x_attack)
                + " "
                + str(gamestate.player[2].speed_y_attack)
                + " "
                + str(gamestate.player[2].speed_y_self),
                concat=True,
            )
